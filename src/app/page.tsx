...
export default function Landing() {
  return (
    ...
    >
      ...
      <div
        className={
          " snap-start shrink-0 grow-0 basis-full lg:basis-[35vw] h-[100svh] w-full [text-shadow:0px_0px_2px_#fff] p-6 bg-black bg-opacity-20 [backdrop-filter:blur(2px)] flex flex-col "
        }
      >
