  ...
  return (
    <main className=" bg-wall flex min-h-screen flex-col items-center justify-between p-24 ">
      <nav className="fixed top-0 left-0 right-0 flex justify-start items-center gap-20 border-b">
        ...
        <DashboardLink id={Views.Favorites} currentView={currentView} onClick={viewSelector}>
          Favorites
        </DashboardLink>
        <DashboardLink id={Views.About} currentView={currentView} onClick={viewSelector}>
          About
        </DashboardLink>
      </nav>
